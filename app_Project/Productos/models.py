...
class Productos(models.Model):
    ...
    name = models.CharField(max_length=50, null=False,
                            blank=False, verbose_name="Producto name")
    precio = models.DecimalField(
        decimal_places=2, max_digits=10, verbose_name="Producto precio")
...
class UserProductos(models.Model):
    ...
    client = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, verbose_name="Client")
    product = models.ForeignKey(
        Productos, on_delete=models.CASCADE, verbose_name="Product")
